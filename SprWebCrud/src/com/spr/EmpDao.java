...
public int save(Emp p){    
    String sql="insert into Emp(ename,sal,job) values('"+p.getName()+"',"+p.getSalary()+",'"+p.getDesignation()+"')";    
    return template.update(sql);    
}    
public int update(Emp p){    
    String sql="update Emp set ename='"+p.getName()+"', sal="+p.getSalary()+",job='"+p.getDesignation()+"' where empid="+p.getId()+"";    
    return template.update(sql);    
}    
